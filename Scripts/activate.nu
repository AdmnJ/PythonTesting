...
let virtual-env = "\\161.191.69.69\data\Github\PythonTesting\FirstProject"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "\\161.191.69.69\data\Github\PythonTesting\FirstProject\Scripts\deactivate.nu"
